...
monodose_FCC_doses_needed <- fudge_doses(buffer_size = sc_model_params$buffer_stock, doses = monodose_FCC_doses) # apply buffer. This formula doesn't seem to be making any impact
