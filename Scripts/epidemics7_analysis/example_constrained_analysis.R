...
dose10_occ_campaign_metrics <- estim_campaign_metrics(
  ...
  site_campaign_mt_delay = dose10_occ_parallel_prep_delay$mt_freezing_time,
  site_campaign_ft_delay = dose10_occ_parallel_prep_delay$ft_freezing_time,
  ft_team_performance = 450,
  mt_team_performance = 250,
  browse = F
)

dose10_occ_campaign_metrics
