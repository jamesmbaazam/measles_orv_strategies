...
server <- function(input, output, session) {
  ...
  observeEvent(input$show_results, {
    if (is.null(input$all_sites_rows_selected)) {
      ...
      monodose_FCC_doses_ft <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          F, pop_type = "near"
      )

      monodose_FCC_doses_mt <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          F, pop_type = "far"
      ...
      monodose_FCC_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
          T, doses_to_transport = monodose_FCC_doses_needed
      )
      #
      #   ceiling(monodose_FCC_doses_needed / 1301) # these numbers refer to the doses along with the diluents
      monodose_FCC_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
      ...
      monodose_FCC_ft <- calc_freezing_time(
        mf314_available =
          input$mf314_quant, large_icepacks_quantity =
          monodose_FCC_RCW25_icepack_needs_total, small_icepacks_quantity = monodose_FCC_vaxCarr_icepack_needs_total
      )
      # output
      ...
      monodose_FCC_far_trip_capacity <- calc_dose_capacity(
        vial_type =
          "monodose", vax_vol =
          21.09, equip_type = "vaxCarr" # we assume a mobile team uses one vaccine carrier
        , with_ice = T
      )
      ...
      output$team_dur_monodoseFCC <- print_site_team_dur(
        site_team_quant =
          site_teams_monodoseFCC, td_fixed =
          team_days_fixed_monodose_FCC, td_mobile = team_days_mobile_monodose_FCC
      )
      ...
      dose10_FCC_doses_near_pop <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          T, pop_type = "near"
      ...
      dose10_FCC_doses_far_pop <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          T, pop_type = "far"
      ...
      dose10_FCC_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
          T, doses_to_transport = dose10_FCC_doses_needed
      )

      dose10_FCC_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
      ...
      # freezing time
      dose10_FCC_ft <- calc_freezing_time(
        mf314_available =
          input$mf314_quant, large_icepacks_quantity =
          dose10_FCC_RCW25_icepack_needs_total, small_icepacks_quantity = dose10_FCC_vaxCarr_icepack_needs_total
      )
      ...
      dose10_FCC_far_trip_capacity <- calc_dose_capacity(
        vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, equip_type = "vaxCarr" # we assume a mobile team uses one vaccine carrier
        , with_ice = T
      )
      ...
      # output for the duration that each team type will spend on site
      output$team_dur_dose10_FCC <- print_site_team_dur(
        site_team_quant =
          site_teams_dose10_FCC, td_fixed =
          team_days_fixed_dose10_FCC, td_mobile = team_days_mobile_dose10_FCC
      )
      ...
      mixed_FCC_dose10_quant <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          T, pop_type = "near"
      ...
      mixed_FCC_monodose_quant <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          F, pop_type = "far"
      ...
      mixed_FCC_dose10_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
          T, doses_to_transport = mixed_FCC_dose10_final
      )

      mixed_FCC_dose10_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
      ...
      mixed_FCC_monodose_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
          T, doses_to_transport = mixed_FCC_monodose_final
      )


      #  ceiling(mixed_FCC_monodose_final / 1301) #Source: Excel sheet "Cold Chain equipment"
      mixed_FCC_monodose_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
      ...
      # freezing time
      mixed_FCC_ft <- calc_freezing_time(
        mf314_available =
          input$mf314_quant, large_icepacks_quantity =
          mixed_FCC_RCW25_icepack_needs, small_icepacks_quantity = mixed_FCC_vaxCarr_icepack_needs
      )
      ...
      mixed_FCC_far_trip_capacity <- calc_dose_capacity(
        vial_type =
          "monodose", vax_vol =
          21.09, equip_type = "vaxCarr" # we assume a mobile team uses one vaccine carrier
        , with_ice = T
      ...
      # output for the duration that each team type will spend on site
      output$team_dur_mixed_FCC <- print_site_team_dur(
        site_team_quant =
          site_teams_mixed_FCC, td_fixed =
          team_days_fixed_mixed_FCC, td_mobile = team_days_mobile_mixed_FCC
      )
      ...
      part_OCC_dose10_quant <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          T, pop_type = "near"
      ...
      part_OCC_monodose_quant <- calc_doses_required(
        df =
          site_table$added_sites, site_rows_selected =
          input$all_sites_rows_selected, is_dose10 =
          F, pop_type = "far"
      ...
      part_OCC_dose10_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
          T, doses_to_transport = part_OCC_dose10_final
      )


      part_OCC_dose10_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "dose10", vax_vol =
          input$vaccine_vol_dose10, with_ice =
      ...
      # passive cold chain required for monodose vials
      part_OCC_monodose_RCW25_needs <- calc_transport_equipment_needs(
        equip_type =
          "rcw25", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
          F, doses_to_transport = part_OCC_monodose_final
      )


      # ceiling(part_OCC_monodose_final / 1301) #Source: Excel sheet "Cold Chain equipment"
      part_OCC_monodose_vaxCarr_needs <- calc_transport_equipment_needs(
        equip_type =
          "vaxCarr", vial_type =
          "monodose", vax_vol =
          input$vaccine_vol_monodose, with_ice =
      ...
      # freezing time
      part_OCC_ft <- calc_freezing_time(
        mf314_available =
          input$mf314_quant, large_icepacks_quantity =
          part_OCC_RCW25_icepack_needs, small_icepacks_quantity = part_OCC_vaxCarr_icepack_needs
      )
      ...
      part_OCC_far_trip_capacity <- calc_dose_capacity(
        vial_type =
          "monodose", vax_vol =
          21.09, equip_type = "vaxCarr" # we assume a mobile team uses one vaccine carrier
        , with_ice = F
      ...
      # output for the duration that each team type will spend on site
      output$team_dur_part_OCC <- print_site_team_dur(
        site_team_quant =
          site_teams_part_OCC, td_fixed =
          team_days_fixed_part_OCC, td_mobile = team_days_mobile_part_OCC
      )
      ...
      # plot theme
      plot_theme <- theme(title = element_text(
        size = 12,
        face = "bold"
      ))
      ...
      output$plot <- renderPlot({
        ft_plot <- ggplot(
          data = freezing_time_results,
          aes(x = Strategy, y = time)
        ) +
          geom_bar(stat = "identity", fill = "steelblue") +
          labs(
            title = "Freezing time required per strategy",
            y = "Freezing time required (days)"
          ) +
          plot_theme

        iceVol_plot <- ggplot(
          data = Init_iceVol_results,
          aes(
            x = Strategy,
            y = iceVol
          )
          ...
          geom_bar(stat = "identity", fill = "steelblue") +
          labs(
            title = "Initial volume of ice required per strategy",
        ...
        td_plot <- ggplot(
          ...
          labs(
            title = "Number of days per team type and strategy",
            y = "Team days"
          ) +
          scale_fill_manual(
