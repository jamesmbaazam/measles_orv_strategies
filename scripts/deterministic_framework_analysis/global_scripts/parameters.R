...
dose10_wr_mt <- 15 #value between 0 and 100; #wastage rate for mobile teams, mt, 15% (twice, compared to fixed teams); I'm assuming this 
monodose_wr_ft <- 3 #value between 0 and 100; #wastage rate for fixed teams, ft, 15% wastage of every 100 doses; known/commonly used by MSF for all campaigns across all strategies
monodose_wr_mt <- 3 #value between 0 and 100; #wastage rate for mobile teams, mt, 15% (twice, compared to fixed teams); I'm assuming this 
